...
import { BadgeDollarSign, Barcode, Car, CreditCardIcon, Users } from "lucide-react";
...
const AdminOverviewPage = async () => {
    ...
    <div className="space-y-2">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0">
                    <CardTitle className="text-lg font-medium">Custormers</CardTitle>
                    <Users/>
                </CardHeader>
                <CardContent>
                            ...
                            {summary.latestSales.map((order) => (
                                <TableRow key={order.id}>
                                    ...
                                    <TableCell>
                                        ...
                                        <span className="px-2 underline text-blue-500">Details</span>
                                        </Link>
                                    </TableCell>
                                </TableRow>
                            ))}
